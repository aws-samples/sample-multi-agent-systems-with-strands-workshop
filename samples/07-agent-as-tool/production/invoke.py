...
response = client.invoke_agent_runtime(
    ...
    payload=json.dumps({"prompt": "MarketNest Premium Tier: Options A ($19.99/mo invite-only), B ($14.99/mo 5% pilot), C ($12.99/mo full launch). Target: +15% CLV in 6 months."}).encode(),
    qualifier="DEFAULT",
)
