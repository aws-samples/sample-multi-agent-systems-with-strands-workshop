...
Conversation state is maintained in the Orchestrator container via
SlidingWindowConversationManager (window_size=20). No external Memory is used.
State persists while the container is warm (same runtimeSessionId).
