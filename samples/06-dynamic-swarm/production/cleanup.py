"""
Cleanup Module 06: Dynamic Swarm — delete AgentCore Runtime and IAM role.

Usage:
    python cleanup.py --name-prefix m6
...
def main():
    parser = argparse.ArgumentParser(description="Delete Module 06 AgentCore Runtime")
    parser.add_argument("--name-prefix", required=True,
                        help="Prefix used when deploying (e.g. m6)")
