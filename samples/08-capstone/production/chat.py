...
actorId scopes long-term memory: same actor-id across sessions remembers you.
"""
import argparse
import json
import os
...
def main():
    ...
    parser.add_argument("--actor-id",    required=True,  help="Your user alias (scopes LTM per user)")
